...
namespace HDClasses
{
    public class SQLCommands
    {
        ...
        {
            HDClasses.Login login1 = new HDClasses.Login();

            // I need to add the location here after C:
            ...
            using (sqlConnection1)
            {
                ...
                using (SqlDataReader read = cmd.ExecuteReader())
                {
                    while (read.Read())
                    {
                        login1._username = read["UserName"].ToString();
                        login1._password = read["Password"].ToString();
                    }
                }
            }
            sqlConnection1.Close();

            if(login1._username==userName && login1._password==password)
            {
                bool logIn = true;
                return logIn;
            }
        ...
        public void UserDataSave(string lastName, string firstName, string middleInitial, string maritalStatus, 
            ...
            string secondaryCity, string secondaryState)
        {
            ...
            System.Data.SqlClient.SqlConnection sqlConnection1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Lioness\\Documents\\GitHub\\HRHelpdesk\\HRHelpdeskApp\\HRHelpdeskApp\\HRHelpdeskApp");
